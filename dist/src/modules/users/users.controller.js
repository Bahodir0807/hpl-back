...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Create employee user' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'List employee users' }),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, permissions_decorator_1.RequirePermissions)('users:read'),
    (0, swagger_1.ApiOperation)({ summary: 'Get employee user card' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Activate or block employee user' }),
    __param(0, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Reset employee user password' }),
    __param(0, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
    __param(1, (0, common_1.Body)()),
