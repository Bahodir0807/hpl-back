...
export declare class LeadsController {
    ...
    create(dto: CreateLeadDto, user: CurrentUserType): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
    ...
    findAll(filterDto: FilterLeadDto, user: CurrentUserType): Promise<{
        items: import("@prisma/client").Lead[];
        total: number;
        page: number;
        limit: number;
    }>;
    ...
    qualify(id: string, dto: QualifyLeadDto, user: CurrentUserType): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        status: import("@prisma/client").$Enums.LeadStatus;
    ...
    disqualify(id: string, dto: DisqualifyLeadDto): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        status: import("@prisma/client").$Enums.LeadStatus;
    ...
    assign(id: string, dto: AssignLeadDto, user: CurrentUserType): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        status: import("@prisma/client").$Enums.LeadStatus;
