...
export const INSTALLATION_CONFIRM_WORK_PERMISSION = 'installation:confirm_work';
...
export const DISTINCT_INSTALLATION_ACTORS_MESSAGE =
...
export const FULFILLMENT_NOTIFICATION = {
  ...
  INSTALLATION_INSTALLER_CONFIRMED: 'installation_installer_confirmed',
